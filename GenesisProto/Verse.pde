class Verse {
  ...
  boolean isJoy, isSadness, isAnger, isFear;
  ...
  Verse(int tID, String tText, JSONArray tTones) {
    ...
    for (int i = 0; i < tTones.size(); i++) {
      ...
      if (toneText.equals("joy") == true) {
        isJoy = true;
      }
      if (toneText.equals("sadness") == true) {
        isSadness = true;
      }
      if (toneText.equals("anger") == true) {
        isAnger = true;
      }
      if (toneText.equals("fear") == true) {
        isFear = true;
      }
